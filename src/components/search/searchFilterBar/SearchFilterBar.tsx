            ...
            {quickAmenities.map((amenity) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex shrink-0 cursor-pointer items-center rounded-full border px-4 py-2 text-sm font-semibold text-foreground md:text-base",
                    isSelected ? "gap-2 border-primary bg-sky-200" : "bg-white",
                  )}
                >
                  {amenity.label}
