...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full w-full rounded-2xl shadow-sm ${stepCircleContainerClassName}`}
      >
        <div
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#e6e6e6", color: "#ffffff" },
          active: { scale: 1, backgroundColor: "#2c48fd", color: "#2c48fd" },
          complete: { scale: 1, backgroundColor: "#2c48fd", color: "#2c48fd" },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#2c48fd" },
  };

  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-gray-100">
      <motion.div
